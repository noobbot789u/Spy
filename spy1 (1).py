...
async def execute_detective_kill(context: ContextTypes.DEFAULT_TYPE, chat_id: int):
    ...
    kill_announcement = f"{target_role_emoji} - [{target_name}](tg://user?id={target_id}) was killed by Detective 👨‍✈️"
    ...
    if killed_players:
        ...
        if len(killed_players) == 1:
            ...
            if detective_also_killed:
                kill_announcement = (
                    f"🔪💥 {killed_role_emoji} - [{killed_name}](tg://user?id={killed_id}) (Detective) was also killed by The spy\n\n"
                    f"Both Detective and Spy killed each other in the night!"
                )
            else:
                kill_announcement = f"{killed_role_emoji} - [{killed_name}](tg://user?id={killed_id}) was killed by The Spy"
        else:
            ...
            for kid in killed_players:
                ...
                killed_info.append(f"{krole_emoji} - [{kname}](tg://user?id={kid})")
        ...
        if kamikaze_killed_by_spy_team:
            ...
            # Send kamikaze revenge announcement
            kamikaze_revenge = f"{killer_emoji} - [{killer_name}](tg://user?id={kamikaze_killed_by_spy_team}) was killed by Kamikaze 💣"
